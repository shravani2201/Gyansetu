class Navbar extends HTMLElement {
    constructor() {
        ...
        this.innerHTML = `
            <nav class="navbar">
                <div class="nav-brand">
                    <img src="/assets/images/logo.svg" alt="GyanSetu Logo" class="nav-logo">
                ...
                <div class="nav-links">
                    ...
                    <a href="/virtual_classroom/index.html" class="nav-link"><i class="fas fa-chalkboard-teacher"></i> Virtual Classroom</a>
                ...
                <div class="profile-dropdown">
                    ...
                    <div class="dropdown-content">
                        <div class="dropdown-header">
                            <img src="${userData?.profileImageUrl || '/assets/images/default-avatar.webp'}" alt="Profile" class="dropdown-profile-img">
